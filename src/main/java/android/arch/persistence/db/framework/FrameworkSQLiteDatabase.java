...
class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery) {
        return this.mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
            /* class android.arch.persistence.db.framework.FrameworkSQLiteDatabase.AnonymousClass1 */
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        return this.mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
            /* class android.arch.persistence.db.framework.FrameworkSQLiteDatabase.AnonymousClass2 */
