        ...
        public void animateIndicatorToPosition(final int i, int i2) {
            ...
            if (i4 != left || i3 != right) {
                ...
                valueAnimator2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class android.support.design.widget.TabLayout.SlidingTabStrip.AnonymousClass1 */
                ...
                valueAnimator2.addListener(new AnimatorListenerAdapter() {
                    /* class android.support.design.widget.TabLayout.SlidingTabStrip.AnonymousClass2 */
