    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetWithDuration(final CoordinatorLayout coordinatorLayout, final AppBarLayout appBarLayout, int i, int i2) {
            ...
            if (valueAnimator2 == null) {
                ...
                this.mOffsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class android.support.design.widget.AppBarLayout.Behavior.AnonymousClass1 */
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (i3 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.mOffsetToChildIndexOnLayoutIsMinHeight) {
                    i2 = i4 + ViewCompat.getMinimumHeight(childAt) + appBarLayout.getTopInset();
                } else {
                    i2 = i4 + Math.round(((float) childAt.getHeight()) * this.mOffsetToChildIndexOnLayoutPerc);
                }
            ...
            if (appBarChildOnOffset != null) {
                ...
                if ((scrollFlags & 1) != 0) {
                    ...
                    if (i2 <= 0 || (scrollFlags & 12) == 0) {
                        if ((scrollFlags & 2) != 0 && (-i) >= (appBarChildOnOffset.getBottom() - minimumHeight) - appBarLayout.getTopInset()) {
                            z2 = true;
                        }
                    } else if ((-i) >= (appBarChildOnOffset.getBottom() - minimumHeight) - appBarLayout.getTopInset()) {
                        z2 = true;
                    }
                }
        ...
        public static class SavedState extends AbsSavedState {
            public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() {
                /* class android.support.design.widget.AppBarLayout.Behavior.SavedState.AnonymousClass1 */
