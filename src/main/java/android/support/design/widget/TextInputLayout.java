        ...
        if (this.mErrorEnabled != z) {
            ...
            if (z) {
                ...
                try {
                    ...
                    z2 = Build.VERSION.SDK_INT >= 23 && this.mErrorView.getTextColors().getDefaultColor() == -65281;
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    ...
                    this.mPasswordToggleView.setOnClickListener(new View.OnClickListener() {
                        /* class android.support.design.widget.TextInputLayout.AnonymousClass4 */
        ...
        if (this.mCollapsingTextHelper.getExpansionFraction() != f) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    /* class android.support.design.widget.TextInputLayout.AnonymousClass5 */
