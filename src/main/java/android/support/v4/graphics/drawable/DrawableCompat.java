...
public final class DrawableCompat {
    ...
    static class DrawableCompatApi21Impl extends DrawableCompatApi19Impl {
        ...
        @Override // android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl, android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl
        public Drawable wrap(Drawable drawable) {
    ...
    static class DrawableCompatApi23Impl extends DrawableCompatApi21Impl {
        @Override // android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatApi21Impl, android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl, android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatApi19Impl
        public Drawable wrap(Drawable drawable) {
            return drawable;
        }
        ...
        @Override // android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatBaseImpl, android.support.v4.graphics.drawable.DrawableCompat.DrawableCompatApi17Impl
        public boolean setLayoutDirection(Drawable drawable, int i) {
