...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    RecyclerView recyclerView = RecyclerView.this;
                    recyclerView.fillRemainingScrollValues(recyclerView.mState);
                    if (i5 != 0) {
                        i4 = RecyclerView.this.mLayout.scrollHorizontallyBy(i5, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i3 = i5 - i4;
                    } else {
                        i4 = 0;
                        i3 = 0;
                    ...
                    if (i6 != 0) {
                        i2 = RecyclerView.this.mLayout.scrollVerticallyBy(i6, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i = i6 - i2;
                    } else {
                        i2 = 0;
                        i = 0;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i5 - i3, i6 - i);
                        } else {
                            smoothScroller.onAnimation(i5 - i3, i6 - i);
                        }
                    }
                ...
                if (!RecyclerView.this.dispatchNestedScroll(i4, i2, i3, i, null, 1) && !(i3 == 0 && i == 0)) {
                    ...
                    if ((i7 != 0 || i3 == currX || overScroller.getFinalX() == 0) && (currVelocity != 0 || i == currY || overScroller.getFinalY() == 0)) {
                ...
                boolean z = (i5 == 0 && i6 == 0) || (i5 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i4 == i5) || (i6 != 0 && RecyclerView.this.mLayout.canScrollVertically() && i2 == i6);
    ...
    public final class Recycler {
        ...
        /* access modifiers changed from: package-private */
        /* JADX WARNING: Removed duplicated region for block: B:94:0x020e  */
