                    ...
                    synchronized (obj2) {
                        try {
                            if (this.zzdnk) {
                                ...
                                obj = obj2;
                                try {
                                    this.zzdnr = new zzaku(this.mContext, next2, this.zzbma, this.zzdmn, next, this.zzdnh.zzdwg, zzwf, this.zzdnh.zzbsp, this.zzbum, this.zzdms, this.zzdnh.zzbti, this.zzdnh.zzbtt, this.zzdnh.zzdwu, this.zzdnh.zzdxp, this.zzdmt);
                                    ...
                                    if (zzj.zzdna == 0) {
                                        ...
                                        this.zzbln.zza(zzrg2, "mls");
                                        this.zzbln.zza(zzrg, "ttm");
                                        return zzj;
                                    }
                                    int i5 = zzj.zzdna;
                                    arrayList.add(next2);
                                    this.zzbln.zza(zzrg2, "mlf");
                                    if (zzj.zzdnc != null) {
