...
public final class zzbox {
    ...
    static byte[] zze(byte[] bArr, byte[] bArr2) {
        if (bArr.length == 32) {
            ...
            long zzf = (((j39 << 26) | j33 | (j26 & j38)) & 4294967295L) + zzf(bArr, 16);
            long j43 = zzf & 4294967295L;
            long zzf2 = (((j39 >> 6) | (j40 << 20)) & 4294967295L) + zzf(bArr, 20) + (zzf >> 32);
            long j44 = zzf2 & 4294967295L;
            long zzf3 = (((j40 >> 12) | (j41 << 14)) & 4294967295L) + zzf(bArr, 24) + (zzf2 >> 32);
            long j45 = zzf3 & 4294967295L;
            byte[] bArr4 = new byte[16];
            zza(bArr4, j43, 0);
            zza(bArr4, j44, 4);
            zza(bArr4, j45, 8);
            zza(bArr4, ((((j41 >> 18) | (j42 << 8)) & 4294967295L) + zzf(bArr, 28) + (zzf3 >> 32)) & 4294967295L, 12);
            return bArr4;
        }
