...
public final class zzbat {
    ...
    public final void zza(ViewGroup viewGroup, zzwf zzwf, String str, String str2) {
        zzbbd.zzeo(str2);
        zza(viewGroup, zzwf, str, SupportMenu.CATEGORY_MASK, ViewCompat.MEASURED_STATE_MASK);
    }

    public final void zza(ViewGroup viewGroup, zzwf zzwf, String str) {
        zza(viewGroup, zzwf, str, ViewCompat.MEASURED_STATE_MASK, -1);
    }
    ...
    private final void zza(ViewGroup viewGroup, zzwf zzwf, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzwf.widthPixels - zza, zzwf.heightPixels - zza, 17));
    ...
    public static boolean zzej(String str) {
        ...
        try {
            ...
            zzbbd.zza(valueOf.length() != 0 ? "Fail to check class type for class ".concat(valueOf) : new String("Fail to check class type for class "), e);
            return false;
        }
    }
}
