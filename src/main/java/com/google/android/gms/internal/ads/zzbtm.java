...
public final class zzbtm implements Comparable<zzbtm>, Map.Entry<K, V> {
    private V value;
    private final /* synthetic */ zzbtf zzftq;
    private final K zzftt;

    zzbtm(zzbtf zzbtf, Map.Entry<K, V> entry) {
        this(zzbtf, entry.getKey(), entry.getValue());
    }
    ...
    public final /* synthetic */ int compareTo(zzbtm zzbtm) {
        return ((Comparable) getKey()).compareTo((Comparable) zzbtm.getKey());
    }
}
