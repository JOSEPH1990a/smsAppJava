...
final class zzbkw implements zzboa {
    ...
    public final zzbjm zzl(byte[] bArr) throws GeneralSecurityException {
        if (bArr.length != this.zzfdw) {
            ...
            return (zzbjm) zzbkb.zzb(this.zzfdv, (zzblr) ((zzbrd) ((zzblr.zza) zzblr.zzagu().zza((zzbrd) this.zzfdx)).zzs(zzbpu.zzi(bArr, 0, this.zzfdw)).zzana()));
        } else if (this.zzfdv.equals("type.googleapis.com/google.crypto.tink.AesCtrHmacAeadKey")) {
            byte[] copyOfRange = Arrays.copyOfRange(bArr, 0, this.zzfdz);
            byte[] copyOfRange2 = Arrays.copyOfRange(bArr, this.zzfdz, this.zzfdw);
            zzblb.zza zzb = zzblb.zzafz().zzdk(this.zzfdy.getVersion()).zzb((zzblf) ((zzbrd) ((zzblf.zza) zzblf.zzagg().zza((zzbrd) this.zzfdy.zzafx())).zzm(zzbpu.zzr(copyOfRange)).zzana()));
            return (zzbjm) zzbkb.zzb(this.zzfdv, (zzblb) ((zzbrd) zzb.zzb((zzbmp) ((zzbrd) ((zzbmp.zza) zzbmp.zzahx().zza((zzbrd) this.zzfdy.zzafy())).zzaf(zzbpu.zzr(copyOfRange2)).zzana())).zzana()));
        } else {
