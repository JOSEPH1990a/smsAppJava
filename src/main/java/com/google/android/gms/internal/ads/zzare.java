...
public final class zzare implements zzari {
    ...
    private final Uri.Builder zza(String str, String str2, String str3, int i) {
        ...
        return appendQueryParameter.appendQueryParameter("device", str6).appendQueryParameter("js", this.zzbpt.zzdp).appendQueryParameter("appid", str4).appendQueryParameter("exceptiontype", str).appendQueryParameter("stacktrace", str2).appendQueryParameter("eids", TextUtils.join(",", zzaan.zzqw())).appendQueryParameter("exceptionkey", str3).appendQueryParameter("cl", "221522000").appendQueryParameter("rc", "dev").appendQueryParameter("session_id", zzwu.zzqa()).appendQueryParameter("sampling_rate", Integer.toString(i)).appendQueryParameter("pb_tm", String.valueOf(zzwu.zzpz().zzd(zzaan.zzcyf)));
    }
}
