            ...
            case 20:
                ...
                if (readStrongBinder3 != null) {
                    ...
                    if (queryLocalInterface3 instanceof zzwx) {
                        zzwx = (zzwx) queryLocalInterface3;
                    } else {
                        zzwx = new zzwz(readStrongBinder3);
                    }
                }
                zza(zzwx);
                parcel2.writeNoException();
            ...
            case 21:
                ...
                if (readStrongBinder4 != null) {
                    ...
                    if (queryLocalInterface4 instanceof zzxz) {
                        ...
                        zzxz = new zzyb(readStrongBinder4);
                    }
                }
                zza(zzxz);
                parcel2.writeNoException();
            ...
            case 36:
                ...
                if (readStrongBinder5 != null) {
                    ...
                    if (queryLocalInterface5 instanceof zzxq) {
                        zzxq = (zzxq) queryLocalInterface5;
                    } else {
                        zzxq = new zzxs(readStrongBinder5);
                    }
                }
                zza(zzxq);
                parcel2.writeNoException();
