    ...
    public static zzki.zza zzd(zzpx zzpx) {
        ...
        if (i == 169 || i == 65533) {
            ...
            if (i2 == zzard) {
                ...
                return zzkp;
            } else if (i2 == zzarb || i2 == zzarc) {
                zzkq zza = zza(readInt, "TIT2", zzpx);
                zzpx.setPosition(position);
                return zza;
            } else if (i2 == zzari || i2 == zzarj) {
                zzkq zza2 = zza(readInt, "TCOM", zzpx);
                zzpx.setPosition(position);
                return zza2;
            } else if (i2 == zzare) {
                ...
                if (readInt == zzarn) {
                    ...
                    if (zzpx.readInt() == zziv.zzaof) {
                        ...
                        if (str2 == null) {
                            ...
                            zzkp = new zzkk(str2, null, 3, bArr);
                        }
                    } else {
