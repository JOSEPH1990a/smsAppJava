...
public final class zzbkb {
    ...
    public static synchronized <P> void zza(String str, zzbjn<P> zzbjn) throws GeneralSecurityException {
        synchronized (zzbkb.class) {
            if (!zzfdk.containsKey(str.toLowerCase()) || zzbjn.getClass().equals(zzfdk.get(str.toLowerCase()).getClass())) {
    ...
    public static <P> zzbjn<P> zzfi(String str) throws GeneralSecurityException {
        if (str != null) {
            zzbjn<P> zzbjn = zzfdk.get(str.toLowerCase());
            if (zzbjn != null) {
                return zzbjn;
            }
            ...
            if (zzbjt != null) {
                ...
                if (zzfdi.containsKey(keyType)) {
                    ...
                    if (!zzbjt.getClass().equals(zzfj.getClass()) || (!booleanValue && z)) {
                        ...
                        throw new GeneralSecurityException(String.format("typeUrl (%s) is already registered with %s, cannot be re-registered with %s", keyType, zzfj.getClass().getName(), zzbjt.getClass().getName()));
                    }
                }
    ...
    public static synchronized <P> zzbmv zza(zzbna zzbna) throws GeneralSecurityException {
        ...
        synchronized (zzbkb.class) {
            ...
            if (zzfdj.get(zzbna.zzaig()).booleanValue()) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v2, resolved type: com.google.android.gms.internal.ads.zzbjz<P> */
    /* JADX WARN: Multi-variable type inference failed */
    public static <P> zzbjz<P> zza(zzbju zzbju, zzbjt<P> zzbjt) throws GeneralSecurityException {
        zzbkc.zzc(zzbju.zzafp());
        zzbjz<P> zzbjz = (zzbjz<P>) new zzbjz();
        for (zzbne.zzb zzb : zzbju.zzafp().zzaiv()) {
