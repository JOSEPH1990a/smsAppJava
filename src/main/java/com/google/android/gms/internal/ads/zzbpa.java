...
public abstract class zzbpa implements zzbov {
    static final int[] zzfkg = zzm(ByteBuffer.wrap(new byte[]{101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107}));
    final zzbou zzfkh;
