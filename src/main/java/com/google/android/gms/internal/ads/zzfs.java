...
public final class zzfs implements Parcelable {
    ...
    public final zzfs zza(zzfs zzfs) {
        ...
        int i2 = this.zzzz | zzfs.zzzz;
        String str3 = this.zzaaa;
        if (str3 == null) {
            str3 = zzfs.zzaaa;
        }
        zzhp zzhp2 = zzfs.zzzm;
        if (zzhp2 != null) {
            zzhp = zzhp2;
        } else {
            zzhp = this.zzzm;
    ...
    public final zzfs zza(zzhp zzhp) {
        return new zzfs(this.zzze, this.zzzi, this.zzzj, this.zzzg, this.zzzf, this.zzzk, this.width, this.height, this.zzzn, this.zzzo, this.zzzp, this.zzzr, this.zzzq, this.zzzs, this.zzzt, this.zzzu, this.zzzv, this.zzzw, this.zzzx, this.zzzz, this.zzaaa, this.zzaab, this.zzzy, this.zzzl, zzhp, this.zzzh);
    }

    public final zzfs zza(zzki zzki) {
        return new zzfs(this.zzze, this.zzzi, this.zzzj, this.zzzg, this.zzzf, this.zzzk, this.width, this.height, this.zzzn, this.zzzo, this.zzzp, this.zzzr, this.zzzq, this.zzzs, this.zzzt, this.zzzu, this.zzzv, this.zzzw, this.zzzx, this.zzzz, this.zzaaa, this.zzaab, this.zzzy, this.zzzl, this.zzzm, zzki);
    }
