...
public final class zzwd implements Parcelable.Creator<zzwb> {
    ...
    public final /* synthetic */ zzwb createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    zzzs = (zzzs) SafeParcelReader.createParcelable(parcel, readHeader, zzzs.CREATOR);
                    break;
                case 11:
                ...
                case 18:
                    ...
                    break;
                case 19:
                    zzvv = (zzvv) SafeParcelReader.createParcelable(parcel, readHeader, zzvv.CREATOR);
                    break;
                case 20:
        ...
        return new zzwb(i, j, bundle, i2, arrayList, z, i3, z2, str, zzzs, location, str2, bundle2, bundle3, arrayList2, str3, str4, z3, zzvv, i4, str5);
    }
}
