...
@VisibleForTesting
final class zzbje implements BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final zzbl zzdj(int i) {
        zzbl zzbl;
        try {
            zzbl = this.zzfct.poll(5000, TimeUnit.MILLISECONDS);
    ...
    private static zzbl zzafl() {
        zzbl zzbl = new zzbl();
        zzbl.zzeo = Long.valueOf((long) PlaybackStateCompat.ACTION_PREPARE_FROM_MEDIA_ID);
        return zzbl;
    }
}
