...
public final /* synthetic */ class zzug {
    static final /* synthetic */ int[] zzbul = new int[zzxs.values().length];
    static final /* synthetic */ int[] zzbvk = new int[zzxx.values().length];
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzug.<clinit>():void");
    }
}
