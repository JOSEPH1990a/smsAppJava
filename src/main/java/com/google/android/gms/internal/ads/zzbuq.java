...
public final class zzbuq {
    ...
    public final int zzalm() throws IOException {
        ...
        int i = zzalr & Byte.MAX_VALUE;
        byte zzalr2 = zzalr();
        if (zzalr2 >= 0) {
            return i | (zzalr2 << 7);
        }
        int i2 = i | ((zzalr2 & Byte.MAX_VALUE) << 7);
        byte zzalr3 = zzalr();
        if (zzalr3 >= 0) {
            return i2 | (zzalr3 << 14);
        }
        int i3 = i2 | ((zzalr3 & Byte.MAX_VALUE) << 14);
        byte zzalr4 = zzalr();
        if (zzalr4 >= 0) {
            return i3 | (zzalr4 << 21);
        }
        int i4 = i3 | ((zzalr4 & Byte.MAX_VALUE) << 21);
        byte zzalr5 = zzalr();
        int i5 = i4 | (zzalr5 << 28);
        if (zzalr5 >= 0) {
            return i5;
    ...
    public final <T extends zzbrd<T, ?>> T zza(zzbsw<T> zzbsw) throws IOException {
        try {
            ...
            if (zzall <= i) {
                ...
                T t = (T) ((zzbrd) this.zzfwh.zza(zzbsw, zzbqq.zzame()));
                zzep(this.zzfly);
                return t;
            }
