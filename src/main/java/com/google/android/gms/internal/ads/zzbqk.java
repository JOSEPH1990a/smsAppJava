...
public abstract class zzbqk extends zzbpt {
    ...
    public static final class zzb extends zza {
        ...
        @Override // com.google.android.gms.internal.ads.zzbqk.zza, com.google.android.gms.internal.ads.zzbqk
    ...
    /* access modifiers changed from: package-private */
    public static final class zzd extends zzbqk {
    ...
    /* access modifiers changed from: package-private */
    public static final class zze extends zzbqk {
        private final ByteBuffer zzaep;
        ...
        public final void zzd(byte b) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j), Long.valueOf(this.zzfml), 1));
        }
        ...
        public final void zzfa(int i) throws IOException {
            ...
            while (true) {
                long j3 = this.zzaha;
                if (j3 >= this.zzfml) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j3), Long.valueOf(this.zzfml), 1));
                } else if ((i & -128) == 0) {
                    this.zzaha = 1 + j3;
                    zzbua.zza(j3, (byte) i);
                    return;
        ...
        public final void zzay(long j) throws IOException {
            ...
            while (true) {
                long j4 = this.zzaha;
                if (j4 >= this.zzfml) {
                    throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(j4), Long.valueOf(this.zzfml), 1));
                } else if ((j & -128) == 0) {
                    this.zzaha = 1 + j4;
                    ...
                    this.zzaha = j4 + 1;
                    zzbua.zza(j4, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
            }
        }
        ...
        public final void write(byte[] bArr, int i, int i2) throws IOException {
            ...
            throw new zzc(String.format("Pos: %d, limit: %d, len: %d", Long.valueOf(this.zzaha), Long.valueOf(this.zzfml), Integer.valueOf(i2)));
        }
    ...
    /* access modifiers changed from: package-private */
    public static class zza extends zzbqk {
        ...
        public final void zzfa(int i) throws IOException {
            if (!zzbqk.zzfme || zzalu() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    this.position = i4 + 1;
                    zzbua.zza(bArr3, (long) i4, (byte) ((i & 127) | 128));
                    i >>>= 7;
                }
        ...
        public final void zzay(long j) throws IOException {
            if (!zzbqk.zzfme || zzalu() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzbua.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    public final void zza(String str, zzbug zzbug) throws IOException {
        logger.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) zzbug);
