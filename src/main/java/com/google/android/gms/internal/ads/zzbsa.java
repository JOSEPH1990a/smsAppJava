...
public final class zzbsa implements zzbtd {
    ...
    public final <T> zzbtc<T> zze(Class<T> cls) {
        ...
        if (zzc.zzaoa()) {
            ...
            return zzbsp.zza(cls, zzc, zzbsv.zzaoe(), zzbrv.zzanr(), zzbte.zzaom(), (zzbqr<?>) null, zzbsi.zzanx());
        } else if (zza(zzc)) {
            return zzbsp.zza(cls, zzc, zzbsv.zzaod(), zzbrv.zzanq(), zzbte.zzaok(), zzbqt.zzamh(), zzbsi.zzanw());
        } else {
            return zzbsp.zza(cls, zzc, zzbsv.zzaod(), zzbrv.zzanq(), zzbte.zzaol(), (zzbqr<?>) null, zzbsi.zzanw());
        }
    }

    private static boolean zza(zzbsj zzbsj) {
        return zzbsj.zzanz() == zzbrd.zze.zzfqj;
    }
