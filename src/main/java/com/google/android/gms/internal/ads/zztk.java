...
public final class zztk {
    public static void zza(String[] strArr, int i, int i2, PriorityQueue<zztl> priorityQueue) {
        ...
        long zzb2 = zzb(16785407, i2 - 1);
        for (int i3 = 1; i3 < (strArr.length - i2) + 1; i3++) {
            long j = zzb + 1073807359;
            zzb = (((((j - ((((((long) zzth.zzba(strArr[i3 - 1])) + 2147483647L) % 1073807359) * zzb2) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzth.zzba(strArr[(i3 + i2) - 1])) + 2147483647L) % 1073807359)) % 1073807359;
    ...
    private static void zza(int i, long j, String str, int i2, PriorityQueue<zztl> priorityQueue) {
        ...
        if ((priorityQueue.size() != i || (priorityQueue.peek().zzbzg <= zztl.zzbzg && priorityQueue.peek().value <= zztl.value)) && !priorityQueue.contains(zztl)) {
