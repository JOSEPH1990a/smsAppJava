...
public final class zzph<T extends zzpi> extends Handler implements Runnable {
    ...
    public final void zzj(boolean z) {
        ...
        if (z) {
            ...
            this.zzbgy.zza((zzpi) this.zzbgx, elapsedRealtime, elapsedRealtime - this.zzbha, true);
        }
    }
    ...
    public final void handleMessage(Message message) {
        ...
        if (!this.zzyb) {
            if (message.what == 0) {
                ...
                if (this.zzbgx.zzfe()) {
                    this.zzbgy.zza((zzpi) this.zzbgx, elapsedRealtime, j, false);
                    return;
                }
                switch (message.what) {
                    case 1:
                    ...
                    case 3:
                        ...
                        if (zza == 3) {
                            ...
                            this.zzbhc = i;
                            zzal((long) Math.min((this.zzbhc - 1) * 1000, (int) NanoHTTPD.SOCKET_READ_TIMEOUT));
                            return;
                        } else {
                            return;
                        }
