...
public final class zzwe {
    ...
    public static zzwb zza(Context context, zzyx zzyx) {
        ...
        Set<String> keywords = zzyx.getKeywords();
        if (!keywords.isEmpty()) {
        ...
        boolean isTestDevice = zzyx.isTestDevice(context2);
        int zzqm = zzyx.zzqm();
        Location location = zzyx.getLocation();
        Bundle networkExtrasBundle = zzyx.getNetworkExtrasBundle(AdMobAdapter.class);
        ...
        return new zzwb(8, time, networkExtrasBundle, gender, list, isTestDevice, zzqm, manualImpressionsEnabled, publisherProvidedId, zzzs, location, contentUrl, zzyx.zzql(), zzyx.getCustomTargeting(), Collections.unmodifiableList(new ArrayList(zzyx.zzqn())), zzyx.zzqi(), str, zzyx.isDesignedForFamilies(), null, zzyx.zzqo(), zzyx.zzqp());
    }
}
