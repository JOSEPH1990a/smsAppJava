...
public final class zzatd extends zzaxv {
    ...
    public final void zzki() {
        ...
        zzbat.zztu.post(new zzate(this, new zzaxg(zzasi, zzc, null, null, zzc.errorCode, zzbv.zzlm().elapsedRealtime(), zzc.zzdyh, null, this.zzdvs)));
    }
    ...
    private final zzasm zzc(zzasi zzasi) {
        ...
        try {
            JSONObject jSONObject = zzbu.get(zzdzr - (zzbv.zzlm().elapsedRealtime() - elapsedRealtime), TimeUnit.MILLISECONDS);
            if (jSONObject == null) {
                return new zzasm(-1);
            }
    ...
    private final JSONObject zza(zzasi zzasi, String str) {
        ...
        try {
            zzatz = zzbv.zzlq().zzt(this.mContext).get();
        } catch (Exception e) {
