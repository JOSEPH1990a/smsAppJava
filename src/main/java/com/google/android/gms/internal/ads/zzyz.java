...
public final class zzyz {
    ...
    public final String getAdUnitId() {
        zzxl zzxl;
        if (this.zzboa == null && (zzxl = this.zzcmo) != null) {
            try {
        ...
        try {
            if (this.zzcmo == null) {
                ...
                if ("search_v2".equals(zza.zzckk)) {
                    ...
                    zzxl = (zzxl) new zzwk(zzwu.zzpw(), context, zza, this.zzboa, this.zzcmj).zzd(context, false);
                }
                this.zzcmo = zzxl;
    ...
    public final void zza(zzvt zzvt) {
        try {
            this.zzciw = zzvt;
            if (this.zzcmo != null) {
                this.zzcmo.zza(zzvt != null ? new zzvu(zzvt) : null);
            }
        } catch (RemoteException e) {
            zzbbd.zzd("#007 Could not call remote method.", e);
        }
