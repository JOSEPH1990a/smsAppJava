            ...
            while (i < i3) {
                ...
                if (zzbud.zzi(b2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        zzbud.zzb(b3, cArr, i7);
                        i7++;
                    }
                    i = i6;
                    i5 = i7;
                } else if (zzbud.zzj(b2)) {
                    if (i6 < i3) {
                        zzbud.zzb(b2, bArr[i6], cArr, i5);
                        i = i6 + 1;
                        i5++;
                    } else {
                        throw zzbrl.zzank();
                    }
                } else if (zzbud.zzk(b2)) {
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzbud.zzb(b2, bArr[i6], bArr[i8], cArr, i5);
                        i = i8 + 1;
                        i5++;
                    } else {
                        throw zzbrl.zzank();
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzbud.zzb(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i = i10 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzbrl.zzank();
