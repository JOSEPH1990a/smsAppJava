...
public final class zzvy {
    ...
    private static void zza(zzvv zzvv, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (replaceFirst.endsWith("List") && !replaceFirst.endsWith("OrBuilderList") && !replaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzgf(concat), zzuo.zza(method2, zzvv, new Object[0]));
                }
            }
            if (replaceFirst.endsWith("Map") && !replaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzgf(concat2), zzuo.zza(method3, zzvv, new Object[0]));
                }
            }
            ...
            if (((Method) hashMap2.get(valueOf5.length() != 0 ? "set".concat(valueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object zza = zzuo.zza(method4, zzvv, new Object[0]);
                    if (method5 == null) {
                        if (zza instanceof Boolean) {
                            ...
                            z2 = zza.equals("");
                        } else if (zza instanceof zzte) {
                            z2 = zza.equals(zzte.zzbtq);
                        } else if (zza instanceof zzvv) {
                            z2 = zza == ((zzvv) zza).zzwj();
                        } else {
                            z2 = zza instanceof Enum ? ((Enum) zza).ordinal() == 0 : false;
                        }
                        z = !z2;
                    } else {
                        z = ((Boolean) zzuo.zza(method5, zzvv, new Object[0])).booleanValue();
                    }
                    if (z) {
        ...
        if (zzvv instanceof zzuo.zzc) {
            Iterator<Map.Entry<Object, Object>> it = ((zzuo.zzc) zzvv).zzbyj.iterator();
            if (it.hasNext()) {
                it.next().getKey();
