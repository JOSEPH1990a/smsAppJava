...
public final class zzbte {
    ...
    public static void zzg(Class<?> cls) {
        Class<?> cls2;
        if (!zzbrd.class.isAssignableFrom(cls) && (cls2 = zzftf) != null && !cls2.isAssignableFrom(cls)) {
    ...
    static int zzd(int i, List<zzbsl> list, zzbtc zzbtc) {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < size; i3++) {
            i2 += zzbqk.zzc(i, list.get(i3), zzbtc);
        }
        return i2;
    }
    ...
    private static zzbtu<?, ?> zzbg(boolean z) {
        try {
            ...
            return (zzbtu) zzaoo.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z));
    ...
    static <T> void zza(zzbsg zzbsg, T t, T t2, long j) {
        zzbua.zza(t, j, zzbsg.zzc(zzbua.zzp(t, j), zzbua.zzp(t2, j)));
    }

    static <T, FT extends zzbqw<FT>> void zza(zzbqr<FT> zzbqr, T t, T t2) {
        zzbqu<FT> zzq = zzbqr.zzq(t2);
        if (!zzq.isEmpty()) {
            zzbqr.zzr(t).zza(zzq);
        }
    }
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (zzbri.zzcb(intValue)) {
                    ...
                    ub2 = (UB) zza(i, intValue, ub2, zzbtu);
                }
            }
            if (i2 != size) {
            ...
            while (it.hasNext()) {
                ...
                if (!zzbri.zzcb(intValue2)) {
                    Object zza = zza(i, intValue2, ub2, zzbtu);
                    it.remove();
                    ub2 = zza;
                }
            }
