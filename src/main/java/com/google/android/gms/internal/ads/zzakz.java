...
public final class zzakz {
    ...
    public static void zza(Context context, String str, zzaxf zzaxf, String str2, boolean z, List<String> list) {
        if (!(list == null || list.isEmpty())) {
            ...
            for (String str4 : list) {
                String zza = zza(zza(zza(zza(zza(zza(zza(str4, "@gw_adlocid@", str2), "@gw_adnetrefresh@", str3), "@gw_qdata@", zzaxf.zzehj.zzdlw), "@gw_sdkver@", str), "@gw_sessid@", zzwu.zzqa()), "@gw_seqnum@", zzaxf.zzdwj), "@gw_adnetstatus@", zzaxf.zzehk);
                if (zzaxf.zzdnb != null) {
                    zza = zza(zza(zza, "@gw_adnetid@", zzaxf.zzdnb.zzdkv), "@gw_allocid@", zzaxf.zzdnb.zzdkx);
                }
                String zzb = zzawz.zzb(zza, context, zzaxf.zzdzf);
                zzbv.zzlf();
    ...
    public static void zza(Context context, String str, List<String> list, @Nullable String str2, @Nullable String str3, @Nullable zzawd zzawd) {
        if (!(list == null || list.isEmpty())) {
            ...
            for (String str4 : list) {
                String zza = zza(zza(zza(str4, "@gw_rwd_userid@", Uri.encode(zzco)), "@gw_rwd_custom_data@", Uri.encode(zzco2)), "@gw_tmstmp@", Long.toString(currentTimeMillis));
                if (zzawd != null) {
                    zza = zza(zza(zza, "@gw_rwd_itm@", Uri.encode(zzawd.type)), "@gw_rwd_amt@", Integer.toString(zzawd.zzefo));
                }
                zzbv.zzlf();
