...
public final class zzaua {
    ...
    public zzaua(Context context) {
        ...
        this.zzecr = zza(packageManager, "http://www.google.com") == null ? false : z;
    ...
    private final void zzr(Context context) {
        ...
        if (registerReceiver != null) {
            ...
            this.zzedi = (double) (((float) registerReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)));
