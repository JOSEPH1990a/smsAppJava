...
public interface zzxy {
    ...
    void zza(int i, zzte zzte) throws IOException;

    <K, V> void zza(int i, zzvo<K, V> zzvo, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzwl zzwl) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzwl zzwl) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzwl zzwl) throws IOException;

    void zzb(int i, String str) throws IOException;

    void zzb(int i, List<zzte> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzwl zzwl) throws IOException;
    ...
    @Deprecated
    void zzbn(int i) throws IOException;
