...
class zzbkf implements zzbjt<zzbjm> {
    ...
    public final zzbsl zzb(zzbsl zzbsl) throws GeneralSecurityException {
        if (zzbsl instanceof zzbld) {
            ...
            return (zzbrd) zzblb.zzafz().zzb((zzblf) zzbkb.zza("type.googleapis.com/google.crypto.tink.AesCtrKey", zzbld.zzagb())).zzb((zzbmp) zzbkb.zza("type.googleapis.com/google.crypto.tink.HmacKey", zzbld.zzagc())).zzdk(0).zzana();
        }
    ...
    public final zzbmv zzc(zzbpu zzbpu) throws GeneralSecurityException {
        return (zzbmv) ((zzbrd) zzbmv.zzaij().zzfl("type.googleapis.com/google.crypto.tink.AesCtrHmacAeadKey").zzai(((zzblb) zzb(zzbpu)).zzakf()).zzb(zzbmv.zzb.SYMMETRIC).zzana());
    }
