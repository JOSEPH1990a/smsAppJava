...
public class zzaok {
    ...
    public final void zzb(int i, int i2, int i3, int i4) {
        try {
            this.zzdin.zza("onSizeChanged", new JSONObject().put("x", i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
    ...
    public final void zzc(int i, int i2, int i3, int i4) {
        try {
            this.zzdin.zza("onDefaultPositionReceived", new JSONObject().put("x", i).put("y", i2).put("width", i3).put("height", i4));
        } catch (JSONException e) {
