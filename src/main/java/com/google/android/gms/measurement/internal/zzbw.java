...
public class zzbw implements zzct {
    ...
    public final boolean zzkv() {
        ...
        if (bool == null || this.zzaqa == 0 || (bool != null && !bool.booleanValue() && Math.abs(this.zzrz.elapsedRealtime() - this.zzaqa) > 1000)) {
