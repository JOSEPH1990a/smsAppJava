    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        if (zzw != null && !zzw.zzju()) {
            ...
            if (intent != null) {
                ...
                ((zzbhh) zzbhc).zza(new zzc((String) map.get("i"), !TextUtils.isEmpty(zzb) ? zza(zzbhc.getContext(), ((zzbhk) zzbhc).zzado(), zzb, ((zzbhm) zzbhc).getView(), zzbhc.zzabw()) : zzb, (String) map.get("m"), (String) map.get("p"), (String) map.get("c"), (String) map.get("f"), (String) map.get("e")));
            }
        } else {
            zzw(true);
            zzbhc.getContext();
