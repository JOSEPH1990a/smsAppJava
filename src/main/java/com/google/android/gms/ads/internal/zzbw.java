...
public final class zzbw implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private zzbw(Context context, zzwf zzwf, String str, zzbbi zzbbi, zzcu zzcu) {
        ...
        if (zzwf.zzckl || zzwf.zzckn) {
            ...
            this.zzbsq = new zzbx(context, str, zzbbi.zzdp, this, this);
    ...
    public final void zzj(View view) {
        zzcq zzab;
        if (((Boolean) zzwu.zzpz().zzd(zzaan.zzctk)).booleanValue() && (zzab = this.zzbso.zzab()) != null) {
            zzab.zzb(view);
        }
    }
    ...
    private final void zzq(boolean z) {
        zzaxf zzaxf;
        View findViewById;
        if (this.zzbsq != null && (zzaxf = this.zzbsu) != null && zzaxf.zzdrv != null && this.zzbsu.zzdrv.zzadl() != null) {
            if (!z || this.zzbua.tryAcquire()) {
                ...
                if (zzbx != null && (findViewById = zzbx.getRootView().findViewById(16908290)) != null) {
                    Rect rect = new Rect();
                    Rect rect2 = new Rect();
    ...
    public final void zzr(boolean z) {
        zzaxf zzaxf;
        if (!(this.zzbtw != 0 || (zzaxf = this.zzbsu) == null || zzaxf.zzdrv == null)) {
