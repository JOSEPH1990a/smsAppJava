...
public class GoogleSignatureVerifier {
    ...
    private final zzm zza(PackageInfo packageInfo) {
        ...
        return (!zza.zzac || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || (honorsDebugCertificates && !zzc.zza(str, zzf, false).zzac)) ? zza : zzm.zzb("debuggable release cert app rejected");
    }
